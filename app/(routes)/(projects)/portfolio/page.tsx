        ...
        <div className="grid gap-10 lg:grid-cols-5">
          <div className="lg:col-span-4">
            ...
            <p className="text-slate-700">
              ...
              development and design skills, using technologies such as React,
              Next.js 14, TypeScript, and Tailwind CSS. I applied responsive web
              design principles to ensure the page looks good on all device
              sizes, including mobile, tablet, and desktops.
            </p>
            ...
            <p className="text-slate-700">
              In this project, I demonstrated the ability to create a
              single-page application, ensuring the code is modular,
              maintainable, and optimized for responsiveness across different
              devices. Additionally, I integrated third-party APIs such as{" "}
              <a
              ...
              for contact form processing, leveraging modern tools like React,
