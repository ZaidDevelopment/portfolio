        ...
        <div className="grid gap-10 lg:grid-cols-5">
          <div className="lg:col-span-4">
            ...
            <p className="text-slate-700">
              Refresh the page to roll the dice, to see who wins, player one or
              player two. A very simple dice game implemented using JavaScript
              and HTML.
            </p>
            ...
            <p className="text-slate-700">
              It was a good small project to see how JavaScript and HTML5 can be
              used together to manipulate the document object model. Not much
              code, but it demonstrates the use of JavaScript, HTML 5, and CSS3.
            </p>
            <div className="mt-5">
              <Link href={"https://github.com/ZaidDevelopment/Dice-Game"}>
              ...
              <Link href={"https://zaiddevelopment.github.io/Dice-Game/"}>
