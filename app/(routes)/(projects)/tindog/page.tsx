        ...
        <div className="grid gap-10 lg:grid-cols-5">
          <div className="lg:col-span-4">
            ...
            <p className="text-slate-700">
              A simple webpage to promote the TinDog app. The webpage was built
              using HTML 5, CSS 3, and Bootstrap.
            </p>
            ...
            <p className="text-slate-700">
              This project provided hands-on experience with HTML 5, CSS 3, and
              Bootstrap, demonstrating how these technologies are used to design
              and build a responsive website. As I have now learned new
              technologies, for new projects I would prefer using more advanced
            ...
            <div className="mt-5">
              <Link
                href="https://github.com/ZaidDevelopment/TinDog"
                target="_blank"
              ...
              <Link
                href="https://zaiddevelopment.github.io/TinDog/"
                target="_blank"
                rel="noopener noreferrer"
              >
